...
/* start address for the .log_que section. defined in linker script */
.word  _slogqueram
/* end address for the .log_que section. defined in linker script */
.word  _elogqueram
...
/* Copy the log_que segment initializers from flash */
  ldr r2, =_slogqueram
  ldr r4, =_elogqueram
  movs r3, #0
  b LoopFillZerologQueInit

FillZerologQueInit:
  str  r3, [r2]
  adds r2, r2, #4

LoopFillZerologQueInit:
  cmp r2, r4
  bcc FillZerologQueInit
